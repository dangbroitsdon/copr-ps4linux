...
Source0:        https://dri.freedesktop.org/%{name}/%{name}-%{version}.tar.xz
Source1:        https://src.fedoraproject.org/rpms/%{name}/raw/rawhide/f/README.rst
Source2:        https://src.fedoraproject.org/rpms/%{name}/raw/rawhide/f/91-drm-modeset.rules
...
Patch1001:      https://src.fedoraproject.org/rpms/%{name}/raw/rawhide/f/%{name}-make-dri-perms-okay.patch
